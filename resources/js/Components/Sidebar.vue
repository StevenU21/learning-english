<template>
    ...
    <aside :class="[
        ...
        'w-64 lg:w-64',
        props.collapsed ? 'lg:w-16' : ''
    ]">
        <div
            :class="['h-16 flex items-center border-b border-gray-200 dark:border-gray-700 px-4 justify-between', props.collapsed ? 'lg:px-2 lg:justify-start lg:gap-1' : '']">
            ...
            <h1 v-show="!effectiveCollapsed"
                class="text-xl font-bold text-gray-800 dark:text-gray-100 whitespace-nowrap">
            ...
            <div class="flex items-center gap-2">
                ...
                <button class="hidden lg:inline-flex"
                    ...
                    @click="toggleCollapsed" :title="collapsed ? 'Expandir' : 'Contraer'">
