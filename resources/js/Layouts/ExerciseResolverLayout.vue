<template>
    <div class="exercise-resolver-layout min-h-screen bg-[#18232a] flex flex-col">
        <!-- Botón X para salir en móvil -->
        <div class="absolute left-0 top-0 pt-6 pl-4 z-20 block sm:hidden">
            <button @click="handleExit"
                class="w-10 h-10 flex items-center justify-center rounded-full bg-[#22313f] hover:bg-[#2c4256] text-white text-xl shadow">
