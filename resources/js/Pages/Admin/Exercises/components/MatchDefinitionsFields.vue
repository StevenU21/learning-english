  ...
  <div class="space-y-5">
    ...
    <div class="space-y-3">
      <div v-for="(pair, idx) in form.options" :key="idx" class="grid grid-cols-2 gap-3 items-center">
        <input v-model="pair.concepto" type="text" placeholder="Concepto" class="rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300" />
        <div class="flex items-center gap-2">
          <input v-model="pair.definicion" type="text" placeholder="Definición" class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300" />
