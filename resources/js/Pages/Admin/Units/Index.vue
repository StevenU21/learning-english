...
const { units } = props;
// Support direct array or paginated object
                                ...
                                >
                                    ...
                                    <td class="px-4 py-2 space-x-2 text-center">
                                        <div class="flex justify-center space-x-2">
                                            ...
                                            <PrimaryButton
                                                @click="confirm('¿Estás seguro?') && $inertia.delete(route('units.destroy', unit.id))"
                                                class="bg-red-500 hover:bg-red-700 text-white"><i
                                                    class="fa-solid fa-trash mr-2"></i> Eliminar</PrimaryButton>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
