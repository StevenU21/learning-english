<template>
    <div
        ...
        <div class="relative h-40 w-full overflow-hidden bg-gray-200 dark:bg-gray-700">
            <template v-if="unit.image_url || unit.image">
                <img :src="unit.image_url || unit.image" :alt="`Imagen de ${unit.name}`"
        ...
        <div class="flex-1 p-4 flex flex-col gap-3">
            <h3 class="font-semibold text-gray-800 dark:text-gray-200 line-clamp-2 text-sm">{{ unit.name }}</h3>
            ...
            <div class="mt-2">
                <div class="h-2 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                    <div class="h-full transition-all duration-500" :class="progressBarColor(unit.progress)"
        ...
        <div class="p-4 pt-0 flex items-center justify-between">
            <Link :href="route('student.units.start', { unit: unit.slug })"
            ...
            <Link :href="route('student.units.resources', { unit: unit.slug })"
                class="inline-flex items-center rounded-md border border-transparent bg-gray-800 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-white transition duration-150 ease-in-out hover:bg-gray-700 focus:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 active:bg-gray-900 dark:bg-gray-200 dark:text-gray-800 dark:hover:bg-white dark:focus:bg-white dark:focus:ring-offset-gray-800 dark:active:bg-gray-300">
